...
def negative_assert_no_firstname(user_body):
    # Guarda el resultado de llamar a la función en la variable "response"
    response = sender_stand_request.post_new_user(user_body)
...
# Prueba 5. Error
# El parametro "firstName" contiene palarbas con un espacio
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("A Aaa")


# Prueba 6. Error
# El parametro "firstName" contiene caracteres especiales
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")


# Prueba 7. Error
# El parametro "firstName" contiene numero
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")


# Prueba 8. Error
# El parametro firstName no se envió
def test_create_user_no_first_name_get_error_response():
    # El diccionario con el cuerpo de la solicitud se copia del archivo data a la variable "user_body"
    # De lo contrario, se podrían perder los datos del diccionario de origen
    user_body = data.user_body.copy()
    # El parametro "firstName" se elimina de la solicitud
...
def test_create_user_empty_first_name_get_error_response():
    # El cuerpo de la solicitud actualizada se guarda en la variante user_body
...
# Prueba 10. Error
# El tipo de parámetro "firstName" es un número
